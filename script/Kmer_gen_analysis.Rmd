...
best_kmers_list <- c(best_kmers_list, "CCTTCT") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "AACCTG") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "CAAGGT") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "CCACCA") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "TCCTCT") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "AACCAA") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "AACCAG") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "GAACCT") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "ACAAGA") ### ADD one manually
best_kmers_list <- c(best_kmers_list, "GGAAGC") ### ADD one manually
...
plot <- ggplot(plot_data, aes(x = Source, y = log10_segm_size, fill = Source, color = Source)) +  
  ...
  theme(legend.position = "none",  
        ...
        axis.text.x = element_text(size = 10, angle = 45, hjust = 1),  # Rotate X-axis labels by 30°
