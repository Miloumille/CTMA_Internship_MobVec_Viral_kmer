...
Generation of the list of K-mers of interest based on the kmers present in all sequences of all fasta found in "v_fasta_folder" that are only appearing in the first x = 100 nulceotides of size k = 6
